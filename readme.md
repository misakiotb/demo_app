...
1回目
```
新しいゲームを作りましょう。math ディレクトリを作成してください。2つの数字を表示して、計算するゲームです。初級編：2～19の数字、たし算のみ中級編：2～99の数字、たし算とひき算回答は、5枚のカードから選ぶ。正解すると〇、間違えると×が表示される。10問やったら終わり。　「5/10 正解！」のようにスコアを表示するまずは初級編のみ作りましょう。
```
